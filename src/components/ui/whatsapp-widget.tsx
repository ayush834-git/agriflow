        ...
        <div className="animate-in slide-in-from-bottom-5 fade-in zoom-in-95 w-[90vw] max-w-[340px] origin-bottom-right rounded-[1.75rem] border border-border/60 bg-card/95 p-5 shadow-[0_24px_80px_-24px_rgba(37,211,102,0.3)] backdrop-blur-xl duration-300">
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              {common.waWidgetDesc ??
                "Send a voice note in Hindi, Telugu, Kannada, or English on WhatsApp to match your inventory, get recommendations, or negotiate prices instantly."}
            </p>
          </div>
          ...
          <div className="mt-5 space-y-3">
            <div className="rounded-[1rem] bg-[#25D366]/10 px-4 py-3 text-sm text-[#25D366]">
              ...
              <span className="opacity-90">
                &quot;I have 50 quintals of Guntur onions, who is paying the best price?&quot;
              </span>
            </div>
            ...
            >
              ...
              >
                ...
                {common.waWidgetConnect ?? "Connect on WhatsApp"}
              </a>
            </Button>
          </div>
        </div>
